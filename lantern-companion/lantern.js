(() => {
  ...
  root.innerHTML = `<style>
    ...
    *{box-sizing:border-box}button,input{font:inherit}button{cursor:pointer;border:1px solid #e7d5b6;background:#fffaf0;color:#473524;border-radius:12px;padding:7px 11px}button:hover{background:#ffedc6}button:focus-visible,input:focus-visible{outline:3px solid #b76d18;outline-offset:3px}
  ...
  function home(){show('Mình ở đây cùng bạn. Cứ làm từng chút một nhé.',[['Mình vừa xong một việc',()=>celebrate()],['Yên lặng 30 phút',()=>{pausedUntil=Date.now()+1800000;active=null;eyeUntil=0;expression(6,1800);show('Mình nghỉ yên ở đây 30 phút nhé.',[['Bật lại',()=>{pausedUntil=0;expressionUntil=0;reset();home();}]]);}]]);}
