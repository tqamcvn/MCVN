(function () {
  ...
  var EXACT = {
    ...
    '⚠ Tuần mới:': '⚠ New week:',
    'Tuần mới:': 'New week:',
    'TQA Short Link': 'TQA Short Link',
    'Rút gọn link': 'Shorten a link',
    'Dán link dài vào đây rồi nhấn Enter…': 'Paste a long link here and press Enter…',
    'Tùy chọn': 'Options',
    'Tiêu đề': 'Title',
    'Đặt tên để tự gợi ý mã (ví dụ: Blog của tôi)': 'Enter a title to suggest a code (for example: My blog)',
    'Mã tùy chỉnh': 'Custom code',
    'Tạo link ngắn →': 'Create short link →',
    'Đang tạo…': 'Creating…',
    '✓ Đã tạo link ngắn': '✓ Short link created',
    '♻️ Link đã tạo trước đó cho URL này': '♻️ An existing short link was found for this URL',
    '📋 Sao chép link': '📋 Copy link',
    '✓ Đã sao chép!': '✓ Copied!',
    'Đã bôi đen — nhấn Ctrl+C': 'Selected — press Ctrl+C',
    '📱 Mã QR': '📱 QR code',
    'Quét bằng camera điện thoại để mở link, hoặc tải về để in/chia sẻ.': 'Scan with your phone camera to open the link, or download it for printing/sharing.',
    '⬇ Tải mã QR (PNG)': '⬇ Download QR code (PNG)',
    '＋ Tạo link khác': '＋ Create another link',
    'Dữ liệu không hợp lệ.': 'Invalid data.',
    'URL không hợp lệ. Vui lòng kiểm tra lại.': 'Invalid URL. Please check it and try again.',
    'Mã tùy chỉnh chỉ gồm chữ, số, dấu gạch ngang/gạch dưới (tối đa 40 ký tự).': 'Custom codes may contain letters, numbers, hyphens, and underscores (up to 40 characters).',
    'Mã này đã được hệ thống giữ chỗ, vui lòng chọn mã khác.': 'This code is reserved. Please choose another one.',
    'Mã tùy chỉnh này đã tồn tại. Vui lòng chọn mã khác.': 'This custom code already exists. Please choose another one.',
    'Không tạo được mã, vui lòng thử lại.': 'Could not create a code. Please try again.',
    'Có lỗi xảy ra, vui lòng thử lại.': 'Something went wrong. Please try again.',
    'Không tìm thấy link': 'Link not found',
    'Link ngắn này không tồn tại hoặc đã bị xóa.': 'This short link does not exist or has been deleted.',
